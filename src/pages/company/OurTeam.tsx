...
const advisoryBoard = [
    ...
    { name: "Dr. Fanindra Pati Pandey", role: "Scientific Advisor", image: "/team/fanindra_pandey.jpeg", bio: "Dr. Fanindra Pati Pandey is a distinguished nanotechnology scientist and agricultural innovator dedicated to advancing sustainable farming through science-driven solutions. With extensive expertise in nanomaterials and agricultural nanotechnology, he is actively contributing to the development of advanced seed priming technologies that enhance seed germination, seedling vigor, nutrient uptake, and stress tolerance. His research focuses on integrating nanotechnology with modern agriculture to improve crop establishment, productivity, and resource-use efficiency while supporting environmentally sustainable farming practices." },
];
