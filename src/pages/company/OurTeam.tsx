...
const teamMembers = [
    ...
    { name: "Parmar Vishal Surendra", role: "Independent Director", image: "/team/vishal.jpeg", bio: "Vishal brings extensive experience in corporate governance and strategic execution." },
    { name: "Mrs. Sudha Navin Agarwal", role: "Non-Executive - Independent Director", image: "/team/user.png", bio: "Sudha Navin Agarwal is an experienced leader contributing to the inclusive growth and strategic vision of the company." },
