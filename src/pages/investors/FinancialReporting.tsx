...
const annualReports: DocumentLink[] = [
    { title: "Annual Report 2025-26", url: "/annual-reports/annual-report-2026.pdf" },
...
const agronicaFinancials: DocumentLink[] = [
    { title: "Financial Statements", tag: "FY 2025-26", url: "/subsidiary-financials/agronica-financials-fy-2025-26.pdf" },
    { title: "Financial Statements", tag: "FY 2024-25", url: "/subsidiary-financials/agronica-financials-fy-2024-25.pdf" },
];
const marsapiFinancials: DocumentLink[] = [
    { title: "Financial Statements", tag: "FY 2025-26", url: "/subsidiary-financials/marsapi-lifesciences-financials-fy-2025-26.pdf" },
];
            ...
            <AccordionItem title="Financials of Subsidiaries">
                <div className="space-y-4 mt-2">
                    <div className="border border-emerald-100 rounded-xl p-5 bg-emerald-50/30">
                        ...
                        <DocumentList documents={agronicaFinancials} />
                    </div>
                    <div className="border border-emerald-100 rounded-xl p-5 bg-emerald-50/30">
                        <div className="flex items-center justify-between mb-3">
                            <h3 className="text-lg font-bold text-emerald-900">MarsAPI Lifesciences Private Limited</h3>
                            <span className="px-3 py-1 bg-emerald-100 text-emerald-700 text-xs font-bold rounded-full uppercase tracking-wider">Subsidiary</span>
                        </div>
                        <DocumentList documents={marsapiFinancials} />
                    </div>
                </div>
            </AccordionItem>
