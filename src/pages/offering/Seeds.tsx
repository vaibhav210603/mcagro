                ...
                <SectionWrapper>
                    <div className="max-w-4xl mx-auto space-y-8">
                        <div className="text-center space-y-4 mb-12">
                            <h1 className="text-4xl md:text-5xl font-bold text-dark">High-Quality Seeds</h1>
                            <p className="text-xl text-gray-600 mx-auto">
                                We provide premium quality seeds that ensure high yield and disease resistance for farmers globally.
                            </p>
                        </div>
